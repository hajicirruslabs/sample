...
ENV CODEQL_HOME ${INSTALL_PATH}/codeql
# Download CodeQL bundle
RUN wget https://github.com/github/codeql-action/releases/latest/download/codeql-bundle.tar.gz -P ${INSTALL_PATH}
# Extract CodeQL bundle
RUN tar -xvzf ${INSTALL_PATH}/codeql-bundle.tar.gz -C ${INSTALL_PATH}
