...
RUN wget https://github.com/github/codeql-action/releases/download/codeql-bundle-20211005/codeql-bundle.tar.gz -P ~/temp
RUN tar -xvzf ~/temp/codeql-bundle.tar.gz -C ~/temp
